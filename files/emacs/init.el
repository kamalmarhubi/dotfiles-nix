...
;; My changes from the version at https://github.com/progfolio/elpaca/blob/master/README.md#installer
...
;; Ensure we have Elpaca's `:ensure` support and that no-littering sets itself
;; up before any other packages load.
(elpaca-wait)
